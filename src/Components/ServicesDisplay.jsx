          ...
          <div className="position-relative">
            ...
            {isMobile ? (
              ...
              >
                <motion.div
                  key={currentIndex}
                  className="col-12 service-display"
                ...
                >
                  <div>
                    <div
                      className="card shadow-sm p-3 mb-5 bg-white border-0 rounded-5 cursor-pointer "                    
                      onClick={() =>
                    ...
                    >
                      ...
                      <div className="card-body">
                        <h4 className="card-title text-service fw-bold text-center">
              ...
              <div className="row mt-4 justify-content-center">
                {services.map((service, index) => (
                  <motion.div
                    className="col-md-4 service-display"
                    key={index}
                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                  ...
                  >
                    <div>
                      <div
                        className="card shadow-sm p-3 mb-5 bg-white service-card border-0 rounded-5 cursor-pointer"
                      ...
                      >
                        ...
                        />
                        <div className="card-body">
                          <h4 className="card-title text-service fw-bold text-center text-md-start">
                            {service.title}
                          </h4>
